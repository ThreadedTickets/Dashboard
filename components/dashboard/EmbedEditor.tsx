...
export default function EmbedEditor({
  ...
  return (
    <div className="bg-primary/10 rounded-lg overflow-hidden text-text">
      <div
      ...
      >
        ...
        <div className="flex items-center">
          <FaTrash
            ...
            className="text-text hover:text-accent mr-3"
          />
          <svg
        ...
        <div className="p-4 pt-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <TextareaInput
                ...
                value={embed.title || ""}
                maxLength={100}
                inputClassName="w-full py-1 px-2 bg-background text-white rounded border border-transparent focus:border-accent/30 transition-colors max-h-10 resize-none"
              />
            </div>
            <div>
          ...
          <div className="mb-4">
            ...
            <TextareaInput
              ...
              inputClassName="w-full py-1 px-2 bg-background text-white rounded border border-transparent focus:border-accent/30 transition-colors min-h-10"
            />
          </div>

          {/* Author */}
          <div className="mb-4 p-3 bg-primary/15 rounded-lg">
          ...
          <div className="flex flex-col gap-4 mb-4">
            <div className="flex justify-between items-center bg-primary/15 p-4 rounded-lg">
            ...
            {embed.fields &&
              ...
              embed.fields?.map((field: any, fieldIndex: number) => (
                <div key={fieldIndex} className="p-3 bg-primary/15 rounded">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-2">
                    ...
                    <div>
                      ...
                      <TextareaInput
                        ...
                        value={field.value}
                        maxLength={1000}
                        inputClassName="w-full py-1 px-2 bg-background text-white rounded border border-transparent focus:border-accent/30 transition-colors h-10 min-h-10 resize-none"
                      />
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-3 bg-primary/15 rounded">
